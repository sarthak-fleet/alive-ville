...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    ...
    gate(rootDir, "verification_surface", "Everything tested", [
      ...
      source("tests/playtests/production-build.ts", ["WEB_ROOT", "dist/web", "dist/server/server.js", "REQUIRED_ASSETS", "/assets/cc0/russpuppy/open_tileset_16.png", "/assets/cutscenes/ashbend_intro_square.mp4", "production 3D canvas should render nonblank pixels", "production agent step should visibly update 3D scene", "Neon Nocturne Playable Slice", "Recover Witness badge for Reva", "production imported noir 3D canvas should render nonblank pixels", "Neon Nocturne: World Ingest Slice", "03-production-noir-import.png", "production mobile imported 3D canvas should render nonblank pixels", "01-production-3d.png", "02-production-mobile.png"]),

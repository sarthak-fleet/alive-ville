...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("tests/playtests/alive-village.ts", ["three-host canvas", "nonBlankCanvasPixels", "canvasPixelHash", "Rotate camera right", "Reset camera", "keyboard.press(\"d\")", "keyboard.press(\"a\")", "Go Herb Garden", "At Herb Garden", "Talk Mira", "dialogue-panel", "toHaveClass(/active/)", "expectNoVerticalOverlap"]),

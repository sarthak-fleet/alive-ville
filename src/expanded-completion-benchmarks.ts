...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/organisms/ThreeWorld.tsx", ["3D travel", "3D target", "3D camera controls", "3D agent activity", "latestAutonomousActivity", "Rotate camera right", "Reset camera", "onKeyDown", "keyboardDestinationFor", "hoverTarget", "movePlayerToward", "openDrawer", "pickup", "inspect", "ashbend:travel-to"]),
    ...
    gate(rootDir, "long_running_agents", "Long-running AI agents", [
      ...
      source("tests/playtests/alive-village.ts", ["Agent loop controls", "1 autonomous ticks", "3D agent activity", "Autonomous t1", "running", "stopped"]),
    ]),

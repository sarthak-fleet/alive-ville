...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "makePathMesh", "makeLabelSprite", "makeLandmarkMesh", "makePropMesh", "locationPalette"]),
      source("web/src/organisms/ThreeWorld.tsx", ["3D travel", "movePlayerToward", "openDrawer", "pickup", "inspect", "ashbend:travel-to"]),
      source("web/src/world-travel.ts", ["movePlayerToward", "shortestLocationRoute"]),
      source("tests/playtests/alive-village.ts", ["three-host canvas", "nonBlankCanvasPixels", "Go Herb Garden", "At Herb Garden", "dialogue-panel", "toHaveClass(/active/)", "expectNoVerticalOverlap"]),

...
export function expandedCompletionReport(rootDir = process.cwd()): ExpandedCompletionReport {
  const gates = [
    gate(rootDir, "three_d_variant", "3D variant", [
      ...
      source("web/src/three/world-scene.ts", ["Raycaster", "onLocationSelect", "onNpcSelect", "onItemSelect", "onPropSelect", "onTargetHover", "onContextStatus", "webglcontextlost", "webglcontextrestored", "orbitCamera", "zoomCamera", "cameraZoomPercent", "resetCamera", "TRAVEL_ANIMATION_MS", "previousActorPositions", "movingActors", "actorMotion", "animateTravel", "makeTargetHalo", "sceneAnimation", "makePathMesh", "makeTerrainGrid", "terrainNode", "terrain-grid", "makeRouteNode", "makeLabelSprite", "makeActorNameplate", "actor-nameplate", "makeLandmarkMesh", "reef_spire", "sonar_dish", "neon_sign", "rain_lamp", "evidence_board", "transformer_stack", "makePropMesh", "makeAtmosphereMesh", "atmosphereKindFor", "locationPalette", "actorBodyShapeFor", "makeActorAccessoryMesh", "bodyShape", "accentColor", "npc.id !== world.player.characterId", "SceneMoodNode", "sceneMoodForClock", "applySceneMood", "timeOfDay", "PCFSoftShadowMap", "applyShadows"]),
      ...
      source("tests/three-world.test.ts", ["structureColor", "landmarks", "forge_tool_rack", "objectives[0]", "terrain", "gridColor", "moves the primary 3D objective beacon", "chosen character as the 3D player avatar", "bodyShape: \"broad\"", "bodyShape: \"caped\"", "bodyShape: \"mechanical\"", "changes 3D lighting mood with the world clock", "fogDensity", "atmosphere", "firefly", "dust", "source-derived artifact visuals", "source-derived location palettes", "conservatory-source.json", "abyssal-source.json", "noir-source.json", "reef_spire", "sonar_dish", "neon_sign", "rain_lamp", "evidence_board", "transformer_stack", "shape: \"gear\"", "shape: \"scrap\""]),
    ...
    gate(rootDir, "verification_surface", "Everything tested", [
      ...
      source("tests/playtests/production-build.ts", ["WEB_ROOT", "dist/web", "dist/server/server.js", "REQUIRED_ASSETS", "/assets/cc0/russpuppy/open_tileset_16.png", "/assets/cutscenes/ashment_intro_square.mp4", "production 3D canvas should render nonblank pixels", "production agent step should visibly update 3D scene", "Reviewed sample worlds", "00-production-world-gallery.png", "Neon Noir imported.", "villageStartHash", "Neon Nocturne Playable Slice", "Recover Witness badge for Reva", "production imported noir 3D canvas should render nonblank pixels", "production noir 3D canvas should visually differ from village", "Neon Nocturne: World Ingest Slice", "03-production-noir-import.png", "production mobile imported 3D canvas should render nonblank pixels", "01-production-3d.png", "02-production-mobile.png"]),

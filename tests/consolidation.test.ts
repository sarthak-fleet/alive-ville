...
describe('sleep-time consolidation', () => {
  test("impressionDue: true once the refresh window passed and there's new player material", () => {
    ...
    npc.memories = [
      {
        tick: 15,
        text: 'The player helped me at the forge.',
        meta: { subject: 'player', importance: 5 },
      },
    ];
  ...
  test('impressionDue: false inside the refresh window', () => {
    ...
    const npc = world.npcs[0]!;
    npc.memories = [
      { tick: 15, text: 'The player helped me.', meta: { subject: 'player', importance: 5 } },
    ];
  ...
  test('scripted consolidation sets a standing impression and advances the tick', () => {
    ...
    npc.memories = [
      {
        tick: 25,
        text: 'The player returned my stolen shears.',
        meta: { subject: 'player', importance: 7 },
      },
    ];

---
title: "web3d — 3D Browser Client Architecture"
description: "3D browser client (R3F + Three + Rapier) module map and worldgen."
---
...
knobs live in [llm-routing.md](./llm-routing.md):

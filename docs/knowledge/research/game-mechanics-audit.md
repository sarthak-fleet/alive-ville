---
title: "Game Mechanics Audit — Basic RPG Standards vs Aliveville, and OSS We Can Steal"
description: "AAA RPG mechanics scorecard and OSS libraries to close gaps."
---
...
- **What to skip**: Convex backend (we use DO + SQLite), their PixiJS renderer
  ...
  observation-only).
- **Already cited** in `docs/product/assets-and-licenses.md` as architecture-only
...
All of these belong in a follow-up doc entry in `docs/product/assets-and-licenses.md`
...
Internal anchors consulted: `docs/architecture/decisions/` (ADR-001/002/003), `docs/knowledge/learnings/lessons.md`, `docs/product/assets-and-licenses.md`, `docs/architecture/web3d-client.md`, `docs/knowledge/experiments/index.md`, `web3d/src/controls/PlayerController.tsx`, `web3d/src/scene/Interior.tsx`, `web3d/src/scene/GameWorld.tsx`, `web3d/src/hud/Hud.tsx`, `web3d/src/hud/StartFlow.tsx`.

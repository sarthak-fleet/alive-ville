...
description: "One-line what/why-here/link entries for external sources."
---
...
TBD: locate the exact SHARP paper citation (referenced in `docs/knowledge/research-lifelikeness.md`).
...
why: explicitly different lane — see `docs/product/positioning.md` for

...
description: "Hard-won implementation lessons from building Aliveville."
---
...
only when a free local backend is active. See `docs/architecture/llm-routing.md`.
...
`docs/knowledge/research-lifelikeness.md` §3 "Sycophancy" and `docs/architecture/probes-harness.md`.
...
`docs/product/assets-and-licenses.md` — license hygiene is non-negotiable.
...
should not. See `docs/product/assets-and-licenses.md` §"VRM Characters".
...
`docs/architecture/probes-harness.md` §"Probe isolation".

---
title: "Retro: Phaser 2D → R3F 3D as the active client"
description: "Retro: Phaser 2D to R3F 3D transition."
---
...
→ See `docs/architecture/decisions/` ADR-012: Phaser retired 2026-06-12; R3F is the only
active runtime.
